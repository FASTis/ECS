                ...
                <div class="form-horizontal">
                    <fieldset>
                       ...
                       <div class="form-group">
                            <asp:Label ID="lblCenter" runat="server" Text="Select Your Center" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                       ...
                       <div class="form-group">
                            <asp:Label ID="lblTask" runat="server" Text="Select Your Activity" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                       ...
                       <div class="form-group">
                            <asp:Label ID="lblMinutes" runat="server" Text="Enter Number of Minutes Volunteered" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">

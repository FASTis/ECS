...
namespace ECS
{
    public partial class EditCompany : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            switch (_mode)
            {
                ...
                case "A":
                    ...
                    break;
                case "D":
                    returnedMessage = String.Format("Please ask your system administrator to deactivate Company ID {0} - {1}.", _id, sCompany);
        ...
        {
            string radalertscript = "<script language='javascript'>function f(){radalert('" + returnedMessage.Replace("'", "`") + "', 300, 100, 'ECS Volunteer App: Edit Company'); Sys.Application.remove_load(f);}; Sys.Application.add_load(f);</script>";
